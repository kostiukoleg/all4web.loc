...
if($_REQUEST['dir']=='template'){
  ...
  //$path = $_SERVER['DOCUMENT_ROOT'].URL::getCutPath().'/mg-templates/'.MG::getSetting('templateName').'/';
  $path = $_SERVER['DOCUMENT_ROOT'].URL::getCutPath().'/mg-templates/'.MG::getSetting('templateName').'/images';
}
if($_REQUEST['dir']=='uploads'){
  $url = SITE.'/uploads';
  $path = $_SERVER['DOCUMENT_ROOT'].URL::getCutPath().'/uploads';  
}
