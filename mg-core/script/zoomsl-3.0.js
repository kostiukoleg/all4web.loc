...
"use strict";
	...
	$.extend(sergelandimagezoomer, {
		...
		dsetting: { //default settings
				...
				zoomrange: [2.12, 10], 						// диапазон зуммирования
				zoomstart: 5,							// стартовая установка зуммирования
				...
				magnifiersize: [324, 324], 					// размер контейнера  
				...
				leftoffset:  10, 						// отступ слева от tmb картинки
				rightoffset: 10, 						// отступ справа от tmb картинки
				switchsides: true,						// учитывать край экрана
                magnifierborder: '1px solid #ccc',     // внешний бордюр
                backgroundMagnifier: "#fff",			// фон контенера
				magnifierTopMargin: -44,			    // поправка на позиционирование по оси Y 
		...
		showimage: function($tracker){
			...
			top1   = coords.top + specs.setting.magnifierTopMargin;
			specs.$magnifier.css({visibility: "visible", display: "none", background: specs.setting.backgroundMagnifier});
