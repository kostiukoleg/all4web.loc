  ...
  <div class="cart">
    <div class="cart-inner">
      <a href="<?php echo SITE ?>/cart">
        ...
        <ul class="cart-list">
          <li class="cart-qty">
            <span class="color"><span class="countsht">(<?php echo $data['cartCount']?$data['cartCount']:0 ?>)шт.</span> - <span class="pricesht"><?php echo $data['cartPrice']?$data['cartPrice']:0 ?></span>  <?php echo $data['currency']; ?></span>
          </li>
        </ul>
      </a>
    </div>
